...
int main(){
    ...
    char argumentsAfterParsing[10][100];//used in parser and after
    int userCommandScroller = 0;
    int argumentScroller = 0;//used in parser
    ...
    while(strcmp(argumentsAfterParsing[0],"exit")!=0){
        ...
        else if(strcmp(argumentsAfterParsing[0],"help")==0)
        {
            ...
            printf("\nSo far you can:\nChange directories 'cd'\nExit 'exit'\nGet cwd 'cwd'\n" 
                "Use vim 'vim'\ncycle command history in history_mode 'h'\nMake directory 'mkdir'\n\n");
        }
